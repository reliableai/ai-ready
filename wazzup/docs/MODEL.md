...
A human posting a message triggers agent users to respond in voice. The rule lives in `wazzup/api/agents.py:respond_to_human_message`, dispatched from the `POST /messages` route.
